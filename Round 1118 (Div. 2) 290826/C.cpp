...
int main() {
    ...
    while (t--) {
        ...
        // You have query(u, v, d) available, returns 1 if dist(u,v) >= d else 0.
        // Budget: 3*n queries per test case.
        // At the end, call answer(u, v, d) with u,v = diameter endpoints, d = diameter length.
